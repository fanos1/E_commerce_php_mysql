...
<head>
    ...
    <title>
        <?php echo isset($page_title) ? $page_title : 'Alphina | bulk walnuts to buy | Nuts to buy '; ?>
    </title>
	
	<meta property="og:title" content="<?php echo isset($fbTitle) ? $fbTitle : 'Fresh Walnuts'; ?>" />
	<meta property="og:type" content="<?php echo isset($fbType) ? $fbType : 'product'; ?>" />
	<meta property="og:url" content="<?php echo isset($fbUrl) ? $fbUrl : 'https://www.alphina.uk/walnuts/9'; ?>" />
	<meta property="og:image" content="<?php echo isset($fbImg) ? $fbImg : 'https://www.alphina.uk/img/walnuts-750-gr.png'; ?>" />	
...
<style type="text/css">	
	...
	<header id="header" style="">	
	    ...
	    <div class="container" id="commonlinks"  >			
  			<div class="col-4 commonlinks"> 			
  				<a href="/cart.php" title="to cart page">
                      <svg class="icon icon-cart" style="font-size: 12px; font-style: italic;"><use xlink:href="#icon-cart"></use></svg>  Cart 
                  </a>
		...
		<nav class="container">
			...
			<!-- MOBILE NAVIGATION. HIDden ON Desktop devices > 576px  -->   
			<div id="mob-nav-wrap">				
				<div class="clearfix"> 
					<!-- 
					<a href="javascript:void(0);"  id="menu-icon" style="text-decoration: none; color: #fff; font-size: 22px;"> 
						&#9776;						
					</a> 
					-->
					<a href="javascript:void(0);"  id="menu-icon" style="text-decoration: none; color: #e27900; "> 
						<svg class="icon icon-menu3" style="text-align: right;"><use xlink:href="#icon-menu3"></use></svg> 
					</a>
					<div id="mb-cart"> 
						<a href="/cart.php">
				...
				<div id="mb-menu-container" class="hide"> 
					...
					<a href="/nuts/6" title="buy nuts">NUTS</a>
					<a href="/walnuts/9" title="Fresh Walnuts to buy">WALNUTS</a> 
					<!-- <a href="/hazelnuts/11/" title="buy hazelnuts page">HAZELNUTS</a> -->
					<a href="/category.php?id=11" title="">hazenlut</a>
				</div>			
			</div>
			...
			<div id="desktop-nav">		
				<div class="col-4">
					...
					<a href="/almonds/8" title="almonds  to buy">ALMONDS</a> 
					<a href="/walnuts/9" title="Fresh Walnuts to buy">WALNUTS</a> 
				</div>
				<div class="col-4">
				...
				<div class="col-4" style="text-align: right;">
					<a href="/nuts/6" title="organic nuts to buy">NUTS</a>
                    
					<a href="/pistachios/10/" title="pistachios page">PISTACHIOS</a> 
					<a href="/hazelnuts/11/" title="home page">HAZELNUTS</a> 
				</div>
			</div>
