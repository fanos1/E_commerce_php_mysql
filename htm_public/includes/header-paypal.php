	...
	<header id="header">	
	    ...
	    <div class="container" id="commonlinks"  >			
			<div class="col-4 commonlinks"> 			
				<a href="/cart.php" title="to cart page"> Cart |</a>
			...
			<div class="col-4 commonlinks"> 
				...
				<a href="/login.php" title="login" style="padding-right: 15px;">Register </a>
			</div>		
	    </div>
			...
			<div id="mob-nav-wrap">				
				<div class="clearfix"> 
					<div id="menu-icon" style=""> 
                        &#9776;
                        <!-- 
                        <div style="width: 30px; height: 2px; background-color: #fff; margin: 6px 0;"> </div>
                        <div style="width: 30px; height: 2px; background-color: #fff; margin: 6px 0;"> </div>
                        <div style="width: 30px; height: 2px; background-color: #fff; margin: 6px 0;"> </div>
                        --> 
                    </div>
